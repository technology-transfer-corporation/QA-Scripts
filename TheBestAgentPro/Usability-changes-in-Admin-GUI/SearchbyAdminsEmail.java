		...
		// TC_ID: TC_04
		// TC_Scenario: B2B-Admin acc -> Agency tab -> SEARCH field -> Enter agency admin email -> click SEARCH bttn -> look for the agency with the search agency admin email (if found = pass, otherwise = fail)
...
public class SearchbyAdminsEmail {
	...
	public static void main(String[] args) throws Exception {
		...
		// Search by Admin's email
		driver.findElement(By.id("search_search")).sendKeys("test.measana+Agency@gmail.com");
		Thread.sleep(1500);
		...
		try { 
			...
			wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("/html/body/div[2]/section[2]/div/div/table/tbody"), "test.measana+Agency@gmail.com"));
		    System.out.println("Admin email search found. As expected. PASS");
		
		} catch (Exception e) {
			System.out.println("Admin email search not found. FAIL");
	   ...
	   TakesScreenshot ts = (TakesScreenshot)driver;
		...
		String desiredName = "D:/AlexP/Trash/SearchByAgencyAdminEmail.png";
		File dstFile = new File(desiredName);
	    int i = 0;
		while (dstFile.exists ()) {
		      i += 1;
		      desiredName = "D:/AlexP/Trash/SearchByAgencyAdminEmail(" + i + ").png";
