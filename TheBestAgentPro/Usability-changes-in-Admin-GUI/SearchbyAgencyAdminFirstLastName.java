			...
			// TC_ID: TC_05
			// TC_Scenario: B2B-Admin acc -> Agency tab -> SEARCH field -> Enter Agency First/Last Name -> click SEARCH bttn -> look for the agency with the corresponding F/L Name (if found = pass, otherwise = fail)
...
public class SearchbyAgencyAdminFirstLastName {
	...
	public static void main(String[] args) throws Exception {
		...
		// Open a browser
				...
				// Search by Agency's First Name
		        WebElement searchfield = driver.findElement(By.id("search_search"));
				searchfield.sendKeys("LongNameToCheckWhenTheLineDoesntFitTheSpa");
				...
				try { 
					...
					wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("/html/body/div[2]/section[2]/div/div/table/tbody"), "LongNameToCheckWhenTheLineDoesntFitTheSpa"));
				    System.out.println("Agency's First name search found. As expected. PASS");
				
				} catch (Exception e) {
					System.out.println("Agency's First name search not found. FAIL");
				...
				// Following code captures the screenshot and place it in specified location
				   TakesScreenshot tss = (TakesScreenshot)driver;
					...
					String desiredName = "D:/AlexP/Trash/SearchByAgencyFirstLastName.png";
					File dstFile = new File(desiredName);
					int i = 0;
					while (dstFile.exists ()) {
					      i += 1;
					      desiredName = "D:/AlexP/Trash/SearchByAgencyFirstLastName(" + i + ").png";
