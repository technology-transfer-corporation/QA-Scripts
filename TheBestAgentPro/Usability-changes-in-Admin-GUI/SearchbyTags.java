			...
			// TC_ID: TC_010
			// TC_Scenario: B2B-Admin acc -> Agency tab -> SEARCH field -> Enter Tag -> click SEARCH bttn -> look for the agency with the corresponding tag (if found = pass, otherwise = fail)
...
public class SearchbyTags {
	...
	public static void main(String[] args) throws Exception {
		...
		// Search by Tag name
		driver.findElement(By.id("search_search")).sendKeys("tg");
		Thread.sleep(1500);
		...
		try { 
		    ...
		    System.out.println("Tag search found. NOT as expected. FAIL");
		
		} catch (Exception e) {
			System.out.println("Tag search not found. PASS");
	   ...
	   TakesScreenshot ts = (TakesScreenshot)driver;
		...
		String desiredName = "D:/AlexP/Trash/SearchByTag.png";
