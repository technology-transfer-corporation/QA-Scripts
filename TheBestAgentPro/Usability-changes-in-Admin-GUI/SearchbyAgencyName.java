			...
			// TC_ID: TC_01
			// TC_Scenario: B2B-Admin acc -> Agency tab -> SEARCH field -> Enter Agency Name -> click SEARCH bttn -> look for the agency with the search name (if found = pass, otherwise = fail)
...
import com.google.common.io.Files;
	...
	public class SearchbyAgencyName {
		...
		public static void main(String[] args) throws Exception {
			...
			driver.findElement(By.id("search_search")).sendKeys("AgencyAsanalooooooooooooooooooooooooooooooooooooooongNametoTest");
			Thread.sleep(1500);
			...
			try { 
				...
				wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("/html/body/div[2]/section[2]/div/div/table/tbody"), "AgencyAsanalooooooooooooooooooooooooooooooooooooooongNametoTest"));
			    System.out.println("Agency name search found. As expected. PASS");
			
			} catch (Exception e) {
				System.out.println("Agency search not found. FAIL");
			...
			// Open the found link
			driver.findElement(By.linkText("Agency QA")).click();
