			...
			// TC_ID: TC_58
			// TC_Scenario: B2B-Admin acc -> Agency tab -> Consortium Column -> Click LookUP Funnel Search -> all agencies returned under selected Consortium  (if found = pass, otherwise = fail)
...
public class ColumnConsortiumLookUpFilterFunnel {
	...
	public static void main(String[] args) throws Exception {
		...
		// Column Host/Consortium Look Up, Funnel, Consortium sort
		driver.findElement(By.xpath("/html/body/div[2]/section[2]/div/div/table/tbody/tr[2]/td[10]/a[2]/i")).click();
		Thread.sleep(3000);
	
	
		try { 
			WebDriverWait wait = new WebDriverWait(driver,2);
			wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("/html/body/div[2]/section[2]/div/div/table"), "HostCInactive"));
		    System.out.println("Funnel found and Filtered successfully. As expected. PASS");
		
		} catch (Exception e) {
			System.out.println("Funnel not found, NOT filtered. FAIL");
	   ...
	   TakesScreenshot ts = (TakesScreenshot)driver;
		...
		String desiredName = "D:/AlexP/Trash/ConsortiumFunnelClick.png";
		File dstFile = new File(desiredName);
	    int i = 0;
		while (dstFile.exists ()) {
		      i += 1;
		      desiredName = "D:/AlexP/Trash/ConsortiumFunnelClick(" + i + ").png";
