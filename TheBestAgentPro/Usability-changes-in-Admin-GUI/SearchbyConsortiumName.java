			...
			// TC_ID: TC_09
			// TC_Scenario: B2B-Admin acc -> Agency tab -> SEARCH field -> Enter Consortium Name -> click SEARCH bttn -> look for the agency with the corresponding Consortium name (if found = pass, otherwise = fail)
...
public class SearchbyConsortiumName {
	...
	public static void main(String[] args) throws Exception {
		...
		// Open a browser
				...
				// Search by Consortium name
				driver.findElement(By.id("search_search")).sendKeys("NConsortiumGUItest");
				Thread.sleep(1500);
				...
				try { 
					...
					wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("/html/body/div[2]/section[2]/div/div/table/tbody"), "NConsortiumGUItest"));
				    System.out.println("Concortium search found. NOT as expected. FAIL");
				
				} catch (Exception e) {
					System.out.println("Consortium search not found. PASS");
